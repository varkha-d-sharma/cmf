...
const ArtifactsPostgres = () => {
  ...
  const handleToggleArtifact = (artifact) => {
    setSelectedArtifacts((prev) => {
      ...
      if (isAlreadySelected)
        return prev.filter((a) => a.artifact_id !== artifact.artifact_id);
  ...
  const handleLabelClick = (labelName, artifact) => {
    ...
    const labelId = labelName.includes(":")
      ? labelName.split(":")[1]
      : labelName;
  ...
  const artifactDetailSummaryFields = selectedArtifact
    ? [
        ...
        {
          label: "Created",
          value: formatArtifactDetailDate(
            selectedArtifact.create_time_since_epoch,
          ),
          color: "indigo",
        },
        {
          label: "Git Repo",
          value: getArtifactDetailProperty("git_repo"),
          color: "purple",
        },
        {
          label: "Commit",
          value: getArtifactDetailProperty("Commit"),
          color: "green",
        },
      ]
    : [];
            ...
            {selectedPipeline && (
              <>
                  ...
                  {selectedStage && selectedArtifactType && (
                    <div className="mb-6 flex items-center gap-3">
                      ...
                      >
                        ...
                        <option value="create_time_since_epoch__asc">
                          Time: Oldest First ↑
                        </option>
                        <option value="create_time_since_epoch__desc">
                          Time: Latest First ↓
                        </option>
                      </select>
                      ...
                      <button
                        ...
                        title={
                          selectedArtifacts.length < 2
                            ? "Select at least 2 artifacts to compare"
                ...
                {!selectedStage && (
                  <div className="text-center py-16">
                    <p className="text-gray-500 text-base font-medium">
                      Please select a stage to view artifacts
                    </p>
                  </div>
                )}
                ...
                {selectedStage && artifactTypes.length === 0 && (
                  <div className="text-center py-16">
                    <p className="text-gray-500 text-base font-medium">
                      No artifact types found for this stage
                    </p>
                  </div>
                )}
              </>

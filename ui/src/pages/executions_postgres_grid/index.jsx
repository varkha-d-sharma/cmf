 ...
 // Stages are pipeline-level metadata shared by execution and artifact views.
  ...
  const handleToggleExecution = (execution) => {
    setSelectedExecutions((prev) => {
      ...
      if (isAlreadySelected)
        return prev.filter((e) => e.execution_id !== execution.execution_id);
  ...
  const executionDetailSummaryFields = selectedExecution
    ? [
        {
          label: "Context Type",
          value: getExecutionDetailProperty("Context_Type"),
          color: "teal",
        },
        {
          label: "Execution",
          value: getExecutionDetailProperty("Execution"),
          color: "blue",
        },
        {
          label: "Pipeline Type",
          value: getExecutionDetailProperty("Pipeline_Type"),
          color: "indigo",
        },
        {
          label: "Git Repo",
          value: getExecutionDetailProperty("Git_Repo"),
          color: "purple",
        },
        {
          label: "Git Start Commit",
          value: getExecutionDetailProperty("Git_Start_Commit"),
          color: "green",
        },
        {
          label: "Git End Commit",
          value: getExecutionDetailProperty("Git_End_Commit"),
          color: "green",
        },
      ]
    : [];
                  ...
                  {selectedStage && (
                    <div className="mb-6 flex items-center gap-3">
                      ...
                      <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold border transition-all shadow-sm ${
                        ...
                        title={
                          selectedExecutions.length < 2
                            ? "Select at least 2 executions to compare"
                            : `Compare ${selectedExecutions.length} executions`
                        }
                      >
                        <svg
                          className="w-4 h-4"
                      ...
                      <div className="grid gap-4 p-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                        {executions.map((execution, index) => (
                          <ExecutionCard
                            ...
                            isSelected={selectedExecutions.some(
                              (e) => e.execution_id === execution.execution_id,
                            )}
